# ESLint Final Report - Lint & Format Pass

**Generated on:** Relife **Branch:** auto/final-lint-pass

## 📊 Executive Summary

- **Files analyzed:** 1,443
- **Files with issues before:** 1,020
- **Files with issues after:** 1,018

### Improvements Made

- **Errors fixed:** 0 (2,693 → 2,693)
- **Warnings fixed:** 7 (3,513 → 3,506)
- **Total issues fixed:** 7

## 🔧 Process Summary

1. ✅ **Backup created:** `backup/pre-final-lint-20250825_093523`
2. ✅ **Branch created:** `auto/final-lint-pass`
3. ✅ **ESLint before state captured:** 19MB of lint data
4. ✅ **ESLint auto-fix executed:** Fixed automatically fixable issues
5. ⚠️ **Prettier formatting:** Encountered connectivity issues (502 Gateway)
6. ✅ **ESLint after state captured:** 19MB of lint data

## 🚨 Current Top Issues Requiring Attention

### Rule Violation Count

1.  **@typescript-eslint/no-unused-vars**: 3,227 violations
2.  **no-undef**: 2,126 violations
3.  **@typescript-eslint/no-require-imports**: 294 violations
4.  **react-hooks/exhaustive-deps**: 198 violations
5.  **unknown**: 104 violations
6.  **no-case-declarations**: 62 violations
7.  **no-unused-vars**: 46 violations
8.  **react-hooks/rules-of-hooks**: 42 violations
9.  **no-useless-escape**: 25 violations
10. **@typescript-eslint/no-unsafe-function-type**: 18 violations
11. **@typescript-eslint/no-namespace**: 14 violations
12. **@typescript-eslint/no-empty-object-type**: 12 violations
13. **react-refresh/only-export-components**: 7 violations
14. **prefer-const**: 6 violations
15. **@typescript-eslint/triple-slash-reference**: 6 violations

## 📋 Top 50 Specific Issues

| File                                                    | Line                                        | Rule                                          | Message                                                         | Suggested Fix                               |
| ------------------------------------------------------- | ------------------------------------------- | --------------------------------------------- | --------------------------------------------------------------- | ------------------------------------------- |
| backup/pre-final-lint-20250825_093523/src/services...   | 40                                          | 🟡 @typescript-eslint/no-unsafe-function-type | The `Function` type accepts any function-like value.            |
| Prefer ...                                              | Review and fix according to rule documen... |
| backup/pre-final-lint-20250825_093523/src/services...   | 348                                         | 🟡 @typescript-eslint/no-unsafe-function-type | The `Function` type accepts any function-like value.            |
| Prefer ...                                              | Review and fix according to rule documen... |
| backup/pre-final-lint-20250825_093523/src/services...   | 355                                         | 🟡 @typescript-eslint/no-unsafe-function-type | The `Function` type accepts any function-like value.            |
| Prefer ...                                              | Review and fix according to rule documen... |
| backup/pre-final-lint-20250825_093523/src/services...   | 69                                          | 🟡 @typescript-eslint/no-unsafe-function-type | The `Function` type accepts any function-like value.            |
| Prefer ...                                              | Review and fix according to rule documen... |
...
| backup/pre-final-lint-20250825*093523/src/\_\_tests*... | 416                                         | 🟡 @typescript-eslint/no-unused-vars          | 'userId' is assigned a value but never used. Allowed unused ... | Remove or prefix with underscore: 'userI... |
...
| backup/pre-final-lint-20250825*093523/src/\_\_tests*... | 277                                         | 🟡 @typescript-eslint/no-unused-vars          | 'timeRange' is assigned a value but never used. Allowed unus... | Remove or prefix with underscore: 'timeR... |
