...
This checklist ensures comprehensive manual accessibility testing beyond automated tools. Use this for every major feature release and before production deployments.
...
### Results Summary
- **Passed**: __ / __ criteria
- **Failed**: __ criteria (list critical failures)
...
**Remember**: This checklist supplements, not replaces, automated testing. Both are essential for comprehensive accessibility coverage!
