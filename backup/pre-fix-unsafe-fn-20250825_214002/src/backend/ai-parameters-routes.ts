...
router.get('/session/:sessionId/status', (req, res) => endpoints.getSessionStatus(req, res));
router.delete('/session/:sessionId', (req, res) => endpoints.closeLiveSession(req, res));

// Configuration Management Routes
router.get('/configuration/:userId', (req, res) => endpoints.getCurrentConfiguration(req, res));
router.get('/configuration/:userId/export', (req, res) => endpoints.exportConfiguration(req, res));
router.post('/configuration/:userId/import', (req, res) => endpoints.importConfiguration(req, res));
...
// Monitoring Routes
router.get('/metrics/:timeRange?', (req, res) => endpoints.getParameterMetrics(req, res));
