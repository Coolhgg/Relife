...
export class SettingsPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    // Sound Settings
    this.defaultSoundSelector = page.locator(
      '[data-testid="default-sound-selector"]',
    );
    this.volumeSlider = page.locator('[data-testid="volume-slider"]');
    this.vibrateToggle = page.locator('[data-testid="vibrate-toggle"]');
    this.gradualVolumeToggle = page.locator(
      '[data-testid="gradual-volume-toggle"]',
    );
    ...
    // Accessibility Settings
    this.screenReaderToggle = page.locator(
      '[data-testid="screen-reader-toggle"]',
    );
    this.highContrastToggle = page.locator(
      '[data-testid="high-contrast-toggle"]',
    );
    this.largeTextToggle = page.locator('[data-testid="large-text-toggle"]');
    this.reducedMotionToggle = page.locator(
      '[data-testid="reduced-motion-toggle"]',
    );
    this.voiceGuidanceToggle = page.locator(
  ...
  async changeTheme(theme: string) {
    ...
    const themeOption = this.page.locator(
  ...
  async changeDefaultSound(sound: string) {
    ...
    const soundOption = this.page.locator(
      `[data-testid="sound-option-${sound}"]`,
    );
  ...
  async verifySettingsPersistence() {
    ...
    await this.switchToTab("general");
    const currentTheme =
      await this.themeSelector.getAttribute("data-current-theme");
  ...
  async verifyPremiumSettings() {
    ...
    const premiumFeatures = this.page.locator(
