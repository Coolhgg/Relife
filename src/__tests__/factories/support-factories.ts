...
export const _createTestUserEmotionalProfile = (
  ...
  return {
    ...
    responsePatterns: {
      ...
      preferredEscalationSpeed: faker.helpers.arrayElement([
        "slow",
        "medium",
        "fast",
      ]),
...
export const _createTestNotification = (
  ...
  return {
    ...
    actionUrl: faker.datatype.boolean({ probability: 0.4 })
      ? generateUrl()
      : undefined,
    metadata: {
      entityId: generateId(),
...
export const _createTestMediaAsset = (
  ...
  return {
    ...
    processing: {
      ...
      variants:
        type === "image" ? ["thumbnail", "medium", "large"] : ["original"],
    },
  } as any;
};
...
const getMimeType = (type: string): string => {
  ...
  return (
    mimeTypes[type as keyof typeof mimeTypes] || "application/octet-stream"
  );
};
