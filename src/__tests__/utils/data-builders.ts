...
export const createUser = (overrides?: Partial<TestUser>) => new TestUserBuilder(overrides);
export const createAlarm = (overrides?: Partial<TestAlarm>) => new TestAlarmBuilder(overrides);
export const createBattle = (overrides?: Partial<TestBattle>) => new TestBattleBuilder(overrides);
