...
expect.extend({
  toBeValidAlarm(received: any) {
    const pass = (
      ...
      ['gentle', 'motivational', 'drill-sergeant', 'zen', 'energetic', 'custom'].includes(received.voiceMood) &&
...
export const assertFastLoad = async (fn: () => Promise<any>, maxTime: number = 1000) => {
