...
class ThemeCombinationsService {
  ...
  private initializeCombinations(): void {
    const combinations: ThemeCombination[] = [
      ...
      // Anime & Pop Culture Combinations
      {
        ...
        description:
          "Dramatic anime-style power-up sequence with electronic music",
        category: "anime",
...

      {
        ...
        name: "Retro Arcade",
        description:
          "8-bit nostalgia with retro visuals and classic gaming sounds",
        category: "retro",
...

      {
        ...
        name: "Jazz Lounge",
        description:
          "Smooth jazz vibes with warm visuals for a relaxed morning",
        category: "classical",
      ...
      // Minimal & Clean Combinations
      {
        ...
        name: "Pure White",
        description:
          "Minimal, clean white design with subtle sounds for maximum focus",
        category: "minimal",
...

      {
        ...
        description:
          "Dark void with minimal distractions for deep meditation wake-up",
        category: "minimal",
      ...
      // Special Occasion Combinations
      {
        ...
        description:
          "Extra motivation boost specifically designed for Monday mornings",
        category: "energetic",
...

      {
        ...
        description:
          "Celebrate the end of the work week with energetic party vibes",
        category: "energetic",
...

      {
        ...
        name: "Lazy Sunday",
        description:
          "Perfect for relaxed Sunday mornings with gentle nature vibes",
        category: "gentle",
  ...
  private initializeCollections(): void {
    const collections: ThemeCollection[] = [
...

      {
        ...
        name: "High Energy",
        description:
          "Powerful and energizing combinations for maximum motivation",
        themes: [
          "lightning_power",
          "workout_beast",
          "monday_motivation",
  ...
  getCombinationsByTags(tags: string[]): ThemeCombination[] {
    return this.getAllCombinations().filter((combo) =>
      tags.some(
        (tag) => combo.tags.includes(tag) || combo.userTags?.includes(tag),
      ),
    );
  }
  ...
  updateCustomCombination(
    id: string,
    updates: Partial<ThemeCombination>,
  ): boolean {
  ...
  getFilteredCombinations(filters: {
    ...
    return this.getAllCombinations().filter((combo) => {
      ...
      if (
        filters.weather &&
        !combo.weatherSuitability.includes(filters.weather)
      )
        return false;
  ...
  private loadUserData(): void {
    try {
      ...
      const customCombosData = localStorage.getItem(
  ...
  private calculateSimilarity(
    ...
    // Time of day overlap
    const commonTimeOfDay = a.timeOfDay.filter((time) =>
      b.timeOfDay.includes(time),
    );
