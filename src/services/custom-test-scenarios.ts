...
export const voiceFeaturesTests: TestScenario[] = [
  {
    id: 'voice-mood-happy',
    message: 'Good morning sunshine! Your energetic alarm is ready to start an amazing day at 7:00 AM tomorrow!',
    priority: 'high',
    context: 'voice',
  ...
  {
    id: 'voice-mood-calm',
    message: 'Your gentle morning alarm has been set for 6:30 AM. Rest well, and wake peacefully tomorrow.',
    priority: 'medium',
    context: 'voice',
  ...
  },
  {
    ...
    message: 'Voice cloning analysis complete. Your personalized wake-up voice is now ready and will greet you with your custom personality tomorrow morning.',
    priority: 'high',
    context: 'voice',
  ...
  },
  {
    ...
    message: 'Voice generation temporarily unavailable. Using default energetic voice for your 7:30 AM alarm. Try voice customization again in a few minutes.',
    priority: 'high',
    context: 'voice',
  ...
  },
  {
    ...
    message: 'Now previewing your motivational voice: "Rise and shine, champion! Today is your day to conquer goals and achieve greatness!"',
    priority: 'medium',
    context: 'voice',
...
export const gamingBattlesTests: TestScenario[] = [
  {
    ...
    message: 'Battle Mode activated! Complete this 30-second math challenge to defeat the Sleep Dragon and turn off your alarm: What is 47 plus 29?',
    priority: 'high',
    context: 'battle',
  ...
  {
    id: 'battle-victory',
    message: 'Victory! You defeated the Sleep Dragon! +50 XP earned, +25 coins awarded. Your alarm is silenced and your 7-day wake-up streak continues!',
    priority: 'high',
    context: 'battle',
  ...
  {
    id: 'battle-defeat',
    message: 'The Sleep Dragon won this round. Alarm continues ringing. Try the next challenge: Solve this memory sequence - 4, 7, 2, 9, 1.',
    priority: 'high',
    context: 'battle',
  ...
  },
  {
    ...
    message: 'Congratulations! Level up to Wake Warrior Level 5! New unlocked: Ultimate Battle Mode with boss fights. Keep conquering those mornings!',
    priority: 'medium',
    context: 'battle',
  ...
  },
  {
    ...
    message: 'Weekly Battle Report: 5 victories, 2 defeats, 320 XP earned. You are ranked #12 in the morning warriors leaderboard!',
    priority: 'low',
    context: 'battle',
...
export const smartSchedulingTests: TestScenario[] = [
  {
    ...
    message: 'Sleep cycle analysis complete. Based on your movement patterns, optimal wake time adjusted from 7:00 to 6:45 AM for lighter sleep phase.',
    priority: 'high',
    context: 'sleep',
  ...
  },
  {
    ...
    message: 'Weather Alert: Heavy rain expected tomorrow morning. Your 6:30 AM alarm moved 15 minutes earlier to account for slower commute time.',
    priority: 'medium',
    context: 'alarm',
  ...
  },
  {
    ...
    message: 'Calendar Conflict Detected: Important meeting moved to 8:00 AM. Your alarm automatically rescheduled from 7:30 to 6:45 AM to ensure preparation time.',
    priority: 'high',
    context: 'alarm',
  ...
  {
    id: 'health-insights',
    message: 'Health Insight: Your average sleep quality this week is 85%. Consider moving bedtime 30 minutes earlier for improved deep sleep phases.',
    priority: 'medium',
    context: 'sleep',
  ...
  },
  {
    ...
    message: 'Smart Snooze adapted to your patterns. Instead of standard 9 minutes, your personalized snooze is now 7 minutes for optimal alertness.',
    priority: 'medium',
    context: 'alarm',
...
export const premiumFeaturesTests: TestScenario[] = [
  {
    ...
    message: 'Premium subscription activated! Welcome to Relife Pro! All advanced features unlocked: voice customization, battle modes, smart scheduling, and unlimited themes.',
    priority: 'high',
    context: 'premium',
  ...
  {
    id: 'feature-locked',
    message: 'Advanced AI Sleep Optimization requires Relife Pro. Upgrade now to unlock intelligent wake timing based on your sleep cycles and daily schedule.',
    priority: 'medium',
    context: 'premium',
  ...
  {
    id: 'trial-expiring',
    message: 'Premium trial expires in 3 days. Continue enjoying unlimited voice themes and advanced scheduling by upgrading to Relife Pro today.',
    priority: 'medium',
    context: 'premium',
  ...
  },
  {
    ...
    message: 'Monthly limit reached for custom voice generation. Upgrade to Pro for unlimited voice customization or wait 12 days for limit reset.',
    priority: 'medium',
    context: 'premium',
  ...
  },
  {
    ...
    message: 'Try Premium Feature: Experience our AI Sleep Optimizer for free! This 3-day trial shows how smart scheduling can improve your sleep quality by 23%.',
    priority: 'low',
    context: 'premium',
...
export const sleepTrackingTests: TestScenario[] = [
  {
    ...
    message: 'Good morning! Last night: 7 hours 23 minutes sleep, 8.2/10 quality score. 2 hours deep sleep, 3.5 hours REM. You are well-rested and ready for the day!',
    priority: 'medium',
    context: 'sleep',
  ...
  },
  {
    ...
    message: 'Sleep Goal Achievement! You have maintained 7+ hours of sleep for 14 consecutive days. Keep up the excellent sleep hygiene!',
    priority: 'medium',
    context: 'sleep',
  ...
  {
    id: 'poor-sleep-alert',
    message: 'Sleep Alert: Only 4.5 hours sleep detected with frequent interruptions. Consider earlier bedtime tonight for better recovery.',
    priority: 'high',
    context: 'sleep',
  ...
  {
    id: 'bedtime-reminder',
    message: 'Smart Bedtime Reminder: To achieve your 7-hour sleep goal and wake refreshed at 6:30 AM, consider starting your bedtime routine in 30 minutes.',
    priority: 'medium',
    context: 'sleep',
  ...
  },
  {
    ...
    message: 'Weekly Sleep Analysis: Average 6.8 hours nightly, improving trend. Best sleep Wednesday with 8.5 hours. Consider replicating Wednesday routine.',
    priority: 'low',
    context: 'sleep',
 ...
 */
export function filterTestsByFeatureAccess(tests: TestScenario[], isPremium: boolean): TestScenario[] {
