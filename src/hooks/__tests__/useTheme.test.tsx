...
describe("useTheme Hook", () => {
  ...
  describe("Personalization", () => {
    ...
    it("should update color preferences", () => {
      ...
      expect(
        result.current.personalization.colorPreferences?.primaryColor,
      ).toBe("#00ff00");
    });
    ...
    it("should update typography preferences", () => {
      ...
      expect(
        result.current.personalization.typographyPreferences?.fontSize,
      ).toBe("large");
    });
    ...
    it("should update motion preferences", () => {
      ...
      expect(
        result.current.personalization.motionPreferences?.reduceMotion,
      ).toBe(true);
    });
    ...
    it("should update sound preferences", () => {
      ...
      expect(result.current.personalization.soundPreferences?.enabled).toBe(
        false,
      );
    });
    ...
    it("should update layout preferences", () => {
      ...
      expect(result.current.personalization.layoutPreferences?.density).toBe(
        "compact",
      );
    });
  ...
  describe("CSS Variables and Classes", () => {
    ...
    it("should check accessibility contrast", () => {
      ...
      const isAccessible = result.current.isAccessibleContrast(
        "#000000",
        "#ffffff",
      );
      ...
      const isNotAccessible = result.current.isAccessibleContrast(
        "#ffff00",
        "#ffffff",
      );
