...
export const REGIONAL_THEMES: Record<string, CulturalTheme> = {
  ...
  "zh-TW": {
    ...
    description:
      "Refined design blending traditional and modern Taiwanese culture",
    colors: {
      primary: "#B91C1C",
      secondary: "#0369A1",
      accent: "#047857",
  ...
  ja: {
    ...
    name: "Japanese Zen",
    description:
      "Minimalist design inspired by Japanese aesthetics and wabi-sabi",
    colors: {
      primary: "#7C2D12",
      secondary: "#0F766E",
      accent: "#DC2626",
  ...
  fr: {
    ...
    name: "French Chic",
    description:
      "Elegant design inspired by French sophistication and artistry",
    colors: {
      primary: "#1E40AF",
      secondary: "#DC2626",
      accent: "#FFFFFF",
  ...
  es: {
    ...
    name: "Spanish Warmth",
    description:
      "Warm, vibrant design inspired by Spanish culture and architecture",
    colors: {
      primary: "#DC2626",
      secondary: "#F59E0B",
      accent: "#059669",
  ...
  "es-MX": {
    ...
    description:
      "Colorful, festive design inspired by Mexican traditions and art",
    colors: {
      primary: "#16A34A",
      secondary: "#DC2626",
      accent: "#F59E0B",
  ...
  "es-419": {
    ...
    description:
      "Passionate design celebrating Latin American diversity and culture",
    colors: {
      primary: "#F97316",
      secondary: "#8B5CF6",
      accent: "#06B6D4",
