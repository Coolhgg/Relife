...
export const PERSONA_CONVERTKIT_CONFIG: Record<
  PersonaType,
  PersonaConvertKitConfig
> = {
  struggling_sam: {
...
export const CONVERTKIT_FORM_TEMPLATES: Record<
  PersonaType,
  ConvertKitFormTemplate
> = {
  struggling_sam: {
    name: "Struggling Sam - Free User Onboarding",
    description: "Gentle onboarding form for price-conscious users",
    successMessage:
      "Welcome! Check your email for helpful tips to get started with Relife completely free.",
    settings: {
  ...
  busy_ben: {
    ...
    successMessage:
      "You're in! We'll send you time-saving tips and productivity hacks.",
  ...
  professional_paula: {
    ...
    successMessage:
      "Thank you for joining! Prepare to unlock advanced productivity insights.",
  ...
  enterprise_emma: {
    ...
    successMessage:
      "Welcome! We'll show you how Relife can transform your team's productivity.",
  ...
  student_sarah: {
    ...
    successMessage:
      "Hey there! 🎓 Check your email for your exclusive student discount.",
  ...
  lifetime_larry: {
    ...
    successMessage:
      "Great choice! We'll show you the incredible lifetime value Relife offers.",
...
export const CONVERTKIT_SEQUENCE_TEMPLATES: Record<
  PersonaType,
...
> = {
  struggling_sam: {
    ...
    description:
      "Supportive 7-email series focusing on free value and gentle encouragement",
    emails: [
      {
  ...
  professional_paula: {
    name: "Professional Paula Advanced Features",
    description:
      "Sophisticated 8-email series showcasing advanced capabilities",
    emails: [
      {
  ...
  student_sarah: {
    name: "Student Sarah Campus Life",
    description:
      "Fun 6-email series for students with discounts and study tips",
    emails: [
      {
