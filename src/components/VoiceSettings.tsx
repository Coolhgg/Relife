...
const VoiceSettings: React.FC<VoiceSettingsProps> = ({
  ...
  const selectedProviderData = providers.find((p: any) => // auto: implicit any p.id === selectedProvider);
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {providers.map((provider: any) => // auto: implicit any (
                <div
                  key={provider.id}
              ...
              {moods.map(mood => {
                ...
                return (
                  ...
                  >
                    ...
                    <select
                      value={currentVoice}
                      onChange={(e: any) => // auto: implicit any handleVoiceMoodChange(mood, e.target.value)}
                    ...
                    >
                      ...
                      {selectedProviderData?.voices.map((voice: any) => // auto: implicit any (
