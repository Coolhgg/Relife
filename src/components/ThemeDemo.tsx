...
const ThemeDemo: React.FC<ThemeDemoProps> = ({ className = "" }) => {
  ...
  const [demoMode, setDemoMode] = useState<"preview" | "interactive">(
    "preview",
  );
      ...
      >
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Transform your Relife experience with powerful visual
                customization tools. Create, share, and discover beautiful
                themes that perfectly match your style.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button
                  onClick={() =>
                    setDemoMode(
                      demoMode === "preview" ? "interactive" : "preview",
                    )
                  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Everything you need to create stunning, accessible, and
              personalized themes for your alarm app
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Preview how your custom themes will look across the entire Relife
              alarm app interface
            </p>
          </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h1
                          ...
                          style={{
                            color:
                              themeConfig?.colors?.text?.primary || "#000000",
                          }}
                        >
                          Good Morning
                        </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Get started with these beautiful preset themes, or use them as
