    ...
    >
      ...
      <div className="setting-group">
        ...
        <input
          ...
          onChange={(
            e: any) => handlePreferenceUpdate('reducedMotion', e.target.checked, 'Reduced motion')
          }
          className="setting-toggle"
        />
      </div>
    ...
    >
      ...
      <div className="setting-group">
        ...
        <input
          ...
          onChange={(
            e: any) => handlePreferenceUpdate('voiceCommands', e.target.checked, 'Voice commands')
          }
          className="setting-toggle"
        />
      </div>
