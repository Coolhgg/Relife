...
describe("BattleSystem", () => {
  ...
  describe("Rendering", () => {
    it("renders battle system tabs correctly", () => {
      ...
      expect(
        screen.getByRole("tab", { name: /active battles/i }),
      ).toBeInTheDocument();
      expect(
        screen.getByRole("tab", { name: /create battle/i }),
      ).toBeInTheDocument();
      expect(
        screen.getByRole("tab", { name: /battle history/i }),
      ).toBeInTheDocument();
    });
  ...
  describe("Battle Types Display", () => {
    it("shows correct battle type information", () => {
      ...
      expect(screen.getByText("📈")).toBeInTheDocument();
      expect(
        screen.getByText("Most consistent wake times"),
      ).toBeInTheDocument();
  ...
  describe("Error Handling", () => {
    it("handles battle creation failures", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText(/failed to create battle/i),
        ).toBeInTheDocument();
      });
    });
    ...
    it("handles network errors gracefully", async () => {
      ...
      mockCallbacks.onSendTrashTalk.mockRejectedValue(
