...
describe("Dashboard", () => {
  ...
  describe("rendering", () => {
    ...
    test("renders quick setup buttons", () => {
      ...
      expect(
        screen.getByRole("button", { name: /work alarm/i }),
      ).toBeInTheDocument();
      expect(
  ...
  describe("interactions", () => {
    ...
    test("calls onToggleAlarm when alarm switch is clicked", async () => {
      ...
      expect(mockProps.onToggleAlarm).toHaveBeenCalledWith(
        testUtils.mockAlarm.id,
      );
    });
    ...
    test("calls onDeleteAlarm when delete is confirmed", async () => {
      ...
      expect(mockProps.onDeleteAlarm).toHaveBeenCalledWith(
        testUtils.mockAlarm.id,
      );
    });
  });
  ...
  describe("accessibility", () => {
    ...
    test("has proper ARIA labels", () => {
      ...
      expect(
        screen.getByLabelText("Dashboard main content"),
      ).toBeInTheDocument();
