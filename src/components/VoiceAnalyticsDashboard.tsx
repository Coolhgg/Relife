...
const VoiceAnalyticsDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'accuracy' | 'personalization' | 'insights'>('overview');
  ...
  const loadVoiceAnalytics = async () => {
    ...
    try {
      ...
      const [usageData, accuracyData, personalizationData, insightsData] = await Promise.all([
        loadUsageAnalytics(),
  ...
  const loadPersonalizationAnalytics = async (): Promise<VoiceAnalytics['personalization']> => {
    return {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-6 flex items-center justify-center">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-lg font-medium text-slate-700">Loading voice analytics...</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-slate-700 mb-2">No Voice Data Available</h3>
          <p className="text-slate-500">Start using voice commands to see your analytics.</p>
        </div>
      </div>
    );
  }
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-800">{analytics.usage.totalCommands.toLocaleString()}</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">
                    {((analytics.usage.successfulCommands / analytics.usage.totalCommands) * 100).toFixed(1)}%
                  </p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-slate-800">{analytics.usage.averageResponseTime}s</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-orange-600">{analytics.accuracy.biometricStrength}%</p>
                </div>
          ...
          >
            {activeTab === 'overview' && (
              <div className="space-y-8">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg">
                  <h3 className="text-xl font-semibold text-slate-800 mb-6">Daily Voice Usage</h3>
                ...
                {/* Top Commands */}
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg">
                  <h3 className="text-xl font-semibold text-slate-800 mb-6">Most Used Commands</h3>
                  <div className="space-y-4">
                    {analytics.usage.topCommands.map((command, index) => (
                      <div key={command.command} className="flex items-center justify-between p-4 bg-gradient-to-r from-slate-50 to-blue-50 rounded-xl">
                        <div className="flex items-center space-x-4">
                          <div className="bg-blue-100 text-blue-600 rounded-full w-8 h-8 flex items-center justify-center font-semibold">
                            {index + 1}
                          </div>
                          <div>
                            <p className="font-medium text-slate-800">"{command.command}"</p>
                            <p className="text-sm text-slate-500">{command.usage_count} uses</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="font-semibold text-green-600">{command.success_rate}%</p>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
                    ...
                    <div className="text-3xl font-bold text-green-600 mb-2">{analytics.accuracy.overallAccuracy}%</div>
                    <p className="text-sm text-slate-500">Recognition accuracy across all commands</p>
                  </div>

                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="font-semibold text-slate-800">Voice Print Quality</h4>
                      <Waveform className="h-5 w-5 text-blue-600" />
                    </div>
                    <div className="text-3xl font-bold text-blue-600 mb-2">{analytics.accuracy.voicePrintQuality.toFixed(1)}%</div>
                    <p className="text-sm text-slate-500">Biometric voice signature strength</p>
                  </div>

                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg">
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="font-semibold text-slate-800">Authentication Success</h4>
                      <Shield className="h-5 w-5 text-purple-600" />
                    </div>
                    <div className="text-3xl font-bold text-purple-600 mb-2">{analytics.accuracy.authenticationSuccess}%</div>
                    <p className="text-sm text-slate-500">Voice-based identity verification</p>
                  </div>
                </div>

                {/* Accuracy Trend */}
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg">
                  <h3 className="text-xl font-semibold text-slate-800 mb-6">Accuracy Trend</h3>
            ...
            {activeTab === 'personalization' && (
              <div className="space-y-8">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <p className="text-sm text-slate-500 mt-2">How well the AI adapts to your patterns</p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 mt-2">Voice pattern learning completion</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg">
                  <h3 className="text-xl font-semibold text-slate-800 mb-6">Voice Mood Effectiveness</h3>
                  <div className="space-y-4">
                    {analytics.personalization.moodEffectiveness.map((mood) => (
                      <div key={mood.mood} className="p-4 bg-gradient-to-r from-slate-50 to-purple-50 rounded-xl">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center space-x-3">
                            <Volume2 className="h-5 w-5 text-purple-600" />
                            <span className="font-medium capitalize text-slate-800">{mood.mood}</span>
                            <span className="text-sm text-slate-500">({mood.usage_count} uses)</span>
                          </div>
            ...
            {activeTab === 'insights' && (
              <div className="space-y-8">
                {/* Achievements */}
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg">
                  <h3 className="text-xl font-semibold text-slate-800 mb-6">Voice Achievements</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  {/* Patterns */}
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg">
                    <h4 className="text-lg font-semibold text-slate-800 mb-4">Usage Patterns</h4>
                    <div className="space-y-3">
                ...
                {/* Next Steps */}
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-lg">
                  <h4 className="text-lg font-semibold text-slate-800 mb-4">Next Steps</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {analytics.insights.nextSteps.map((step, index) => (
                      <div key={index} className="flex items-center space-x-3 p-4 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl">
