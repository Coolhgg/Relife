      ...
      <div className="bg-white dark:bg-dark-800 rounded-xl shadow-2xl p-6 max-w-md w-full">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-yellow-700 dark:text-yellow-300 text-sm mt-1">
                  These buttons trigger intentional errors to test error
                  boundaries. The app should gracefully handle these errors
                  without crashing.
                </p>
              </div>
            </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="text-left">
              ...
              <div className="text-xs opacity-75">
                Simulates AI/ML service failure
              </div>
            </div>
          </button>
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-500 dark:text-gray-400">
            After triggering an error, check that the error boundary displays
            properly and allows you to recover or retry.
          </p>
        </div>
      </div>
    </div>
