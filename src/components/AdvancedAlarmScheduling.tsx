                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 text-sm text-muted-foreground">
                  ...
                  {alarm.smartOptimizations && alarm.smartOptimizations.length > 0 && (
                    <div className="flex items-center gap-1">
                      <Brain size={12} />
                      <span>
                        {alarm.smartOptimizations.filter((o: any) => o // auto: implicit any.isEnabled).length}{' '}
                        optimizations
                      </span>
                    </div>
                  )}
                  ...
                  {alarm.conditionalRules && alarm.conditionalRules.length > 0 && (
                    <div className="flex items-center gap-1">
                      <Zap size={12} />
                      <span>
                        {alarm.conditionalRules.filter((r: any) => r // auto: implicit any.isActive).length}{' '}
                        conditions
                      </span>
                    </div>
                  )}
                  ...
                  {alarm.locationTriggers && alarm.locationTriggers.length > 0 && (
                    <div className="flex items-center gap-1">
                      <MapPin size={12} />
                      <span>
                        {alarm.locationTriggers.filter((t: any) => t // auto: implicit any.isActive).length}{' '}
                        locations
                      </span>
                    </div>
                  )}
