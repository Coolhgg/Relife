  ...
  const takeScreenshot = async () => {
    try {
      ...
      video.addEventListener('loadedmetadata', () => {
        ...
        setFeedbackData((prev: any) => ({ ...prev, screenshot: screenshotData }));
        ...
        {types.map(type => {
          ...
          return (
            <button
              key={type.id}
              onClick={() =>
                setFeedbackData((prev: any) => ({ ...prev, type: type.id as any }))
              }
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-2">
            {[1, 2, 3, 4, 5].map(star => (
              <button
                key={star}
                onClick={() => setFeedbackData((prev: any) => ({ ...prev, rating: star }))}
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-xl">
            ...
            <Switch
              ...
              onCheckedChange={(checked: any) => /* auto: implicit any */
                setFeedbackData((prev: any) => ({ ...prev, isAnonymous: checked }))
              }
            />
          </div>
        )}
          ...
          {customCategories.map(category => {
            ...
            return (
              <button
                key={category.id}
                onClick={() =>
                  setFeedbackData((prev: any) => ({ ...prev, category: category.id as any }))
                }
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        setScreenshot(null);
                        setFeedbackData((prev: any) => ({ ...prev, screenshot: null }));
                      }}
                    >
                      <X className="w-4 h-4" />
                    </Button>
