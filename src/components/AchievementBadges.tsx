...
export const AchievementBadges: React.FC<AchievementBadgesProps> = ({
  ...
  const unlockedAchievements = achievements.filter((a: any) => // auto: implicit any a.unlockedAt);
  const lockedAchievements = achievements.filter((a: any) => // auto: implicit any !a.unlockedAt);
