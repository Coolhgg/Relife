    ...
    const SpinnerContent = useMemo((
      ...
      if (isLowEnd || tier === 'low-end') {
        return (
          <div className={`${sizeClasses} ${colorClasses}`}>
            <div
              className={`w-full h-full border-2 border-current border-t-transparent rounded-full ${animationClasses}`}
            />
          </div>
        );
      }
      ...
      if (tier === 'mid-range') {
        return (
          <div className={`${sizeClasses} ${colorClasses}`}>
            <div
              className={`w-full h-full border-2 border-gray-200 rounded-full ${animationClasses}`}
            >
      ...
      return (
        <div className={`relative ${sizeClasses} ${colorClasses}`}>
          <div
            className={`absolute inset-0 border-2 border-gray-200 rounded-full ${animationClasses}`}
          />
          <div
            className={`absolute inset-0 border-2 border-current border-t-transparent rounded-full ${animationClasses}`}
          />
          <div
