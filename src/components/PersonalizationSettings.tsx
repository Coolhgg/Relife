      ...
      <div>
        <label className="flex items-center justify-between">
          ...
          <input
            ...
            onChange={(e: any) => updateMotionPreference('enableAnimations', e.target.checked)}
            className="h-4 w-4 text-blue-600 rounded border-gray-300"
          />
        </label>
      </div>
      ...
      <div>
        <label className="flex items-center justify-between">
          ...
          <input
            ...
            onChange={(e: any) => updateMotionPreference('reduceMotion', e.target.checked)}
            className="h-4 w-4 text-blue-600 rounded border-gray-300"
          />
        </label>
      </div>
      ...
      <div>
        <label className="flex items-center justify-between">
          ...
          <input
            ...
            onChange={(e: any) => updateSoundPreference('enableSounds', e.target.checked)}
            className="h-4 w-4 text-blue-600 rounded border-gray-300"
          />
        </label>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <label className="flex items-center justify-between">
          ...
          <input
            ...
            onChange={(e: any) => updateSoundPreference('hapticFeedback', e.target.checked)}
            className="h-4 w-4 text-blue-600 rounded border-gray-300"
          />
        </label>
        ...
        <label className="flex items-center justify-between">
          ...
          <input
            ...
            onChange={(e: any) => updateSoundPreference('muteOnFocus', e.target.checked)}
            className="h-4 w-4 text-blue-600 rounded border-gray-300"
          />
        </label>
      </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <select
          ...
          onChange={(e: any) => updateLayoutPreference('density', e.target.value as any)}
          className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg"
        >
      ...
      <div>
        ...
        <select
          ...
          onChange={(e: any) => updateLayoutPreference('cardStyle', e.target.value as any)}
          className="w-full px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg"
        >
      ...
      <div className="grid grid-cols-2 gap-4">
        <label className="flex items-center justify-between">
          ...
          <input
            ...
            onChange={(e: any) => updateLayoutPreference('showLabels', e.target.checked)}
            className="h-4 w-4 text-blue-600 rounded border-gray-300"
          />
        </label>
