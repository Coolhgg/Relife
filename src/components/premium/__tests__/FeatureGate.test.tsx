...
describe("FeatureGate", () => {
  ...
  describe("Access Control", () => {
    ...
    it("shows upgrade prompt when user lacks access", () => {
      ...
      mockUseFeatureGate.upgradeMessage =
  ...
  describe("Upgrade Prompts", () => {
    beforeEach(() => {
      ...
      mockUseFeatureGate.requiredTier = "premium";
      mockUseFeatureGate.upgradeMessage =
        "Upgrade to Premium to access premium voices";
    });
    ...
    it("displays custom message when provided", () => {
      const customMessage =
        "Special offer: Get premium voices for just $5/month!";
...
describe("withFeatureGate HOC", () => {
  ...
  it("wraps component with feature gate", () => {
    const WrappedComponent = withFeatureGate(
      TestComponentForHOC,
      "premium_themes",
    );
