...
describe("FeatureBadge", () => {
  describe("Rendering", () => {
    ...
    it("applies custom className", () => {
      renderWithProviders(
        <FeatureBadge tier="premium" className="custom-class" />,
      );
...
describe("FeatureComparison", () => {
  ...
  describe("Rendering", () => {
    ...
    it("shows feature descriptions", () => {
      ...
      expect(
        screen.getByText("Create as many alarms as you need"),
      ).toBeInTheDocument();
      expect(
        screen.getByText("Share alarms with your team"),
      ).toBeInTheDocument();
    });
...
describe("PremiumFeatureTooltip", () => {
  ...
  describe("Rendering", () => {
    ...
    it("hides tooltip on mouse leave", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.queryByText("Advanced Analytics"),
        ).not.toBeInTheDocument();
      });
    });
  });
  ...
  describe("Accessibility", () => {
    ...
    it("announces warnings to screen readers", () => {
      ...
      expect(announcement).toHaveTextContent(
        "Usage limit reached for Custom Alarms",
      );
    });
  });
});
