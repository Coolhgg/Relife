            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p
                    className={`text-sm capitalize ${getTierColor(member.tier)}`}
                  >
                    {member.tier} member
                  </p>
                </div>
...
export function PremiumTeamFeatures({
  className = "",
}: PremiumTeamFeaturesProps) {
  const { user } = useAuth();
