...
export const oceanBreezeTheme: ThemeConfig = {
  ...
  description:
    "Calming oceanic theme with smooth gradients and gentle transitions",
  category: "premium",
  isCustom: false,
  isPremium: true,
  colors: {
  ...
  effects: {
    ...
    gradients: {
      ...
      background:
        "linear-gradient(135deg, #f8fcff 0%, #e0f2fe 50%, #bae6fd 100%)",
      surface:
...
export const sunsetGlowTheme: ThemeConfig = {
  ...
  colors: {
    ...
    background: {
      ...
      gradient:
        "linear-gradient(135deg, #fffbf8 0%, #fef7f0 50%, #fed7aa 100%)",
    },
    text: {
      primary: "#7c2d12",
      secondary: "#9a3412",
  ...
  effects: {
    ...
    gradients: {
      ...
      secondary:
        "linear-gradient(135deg, #d946ef 0%, #c026d3 50%, #a21caf 100%)",
...
export const forestDreamTheme: ThemeConfig = {
  ...
  colors: {
    ...
    background: {
      ...
      gradient:
        "linear-gradient(135deg, #fdfffe 0%, #f0fdf4 50%, #dcfce7 100%)",
    },
    text: {
      primary: "#14532d",
      secondary: "#166534",
