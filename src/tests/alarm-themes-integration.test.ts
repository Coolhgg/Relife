...
describe("Alarm Themes Integration", () => {
  ...
  describe("Sound Effects Service Integration", () => {
    ...
    it("should have expanded sound effect IDs", () => {
      ...
      const gentleSounds = allSounds.filter((s) =>
        s.id.includes("tibetan_bowls"),
      );
      expect(gentleSounds.length).toBe(1);

      // Check for new energetic sounds
      const energeticSounds = allSounds.filter((s) =>
        s.id.includes("power_up"),
      );
  ...
  describe("Visual Alarm Themes Integration", () => {
    ...
    it("should recommend visual themes based on sound themes", () => {
      const natureVisual =
        visualAlarmThemes.getRecommendedVisualTheme("nature");
    ...
    it("should categorize themes correctly", () => {
      ...
      const energeticThemes =
        visualAlarmThemes.getThemesByCategory("energetic");
  ...
  describe("Contextual Themes Integration", () => {
    ...
    it("should handle different times of day", async () => {
      const earlyMorning =
        await contextualThemes.getContextualRecommendation("5:00");
      const lateNight =
        await contextualThemes.getContextualRecommendation("23:00");
  ...
  describe("Theme Combinations Integration", () => {
    it("should load predefined combinations", () => {
      ...
      const peacefulSunrise =
        themeCombinations.getCombination("peaceful_sunrise");
    ...
    it("should categorize combinations correctly", () => {
      const gentleCombos =
        themeCombinations.getCombinationsByCategory("gentle");
      const energeticCombos =
        themeCombinations.getCombinationsByCategory("energetic");
    ...
    it("should filter by time of day", () => {
      const morningCombos =
        themeCombinations.getCombinationsByTimeOfDay("morning");
    ...
    it("should provide personalized recommendations", () => {
      ...
      const recommendations =
        themeCombinations.getPersonalizedRecommendations(3);
  ...
  describe("Cross-Service Integration", () => {
    it("should integrate visual and sound theme recommendations", () => {
      ...
      const visualTheme =
        visualAlarmThemes.getRecommendedVisualTheme(soundTheme);
  ...
  describe("Performance and Error Handling", () => {
    it("should handle missing themes gracefully", () => {
      const nonExistentTheme = visualAlarmThemes.getTheme(
        "non_existent_theme" as any,
      );
      expect(nonExistentTheme).toBeUndefined();

      const nonExistentCombo =
        themeCombinations.getCombination("non_existent_combo");
