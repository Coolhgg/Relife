  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    for (let j = 0; j < frequencies.length; j++) {
      ...
      if (time >= delay) {
        ...
        sample +=
          Math.sin(2 * Math.PI * frequencies[j] * 2 * adjustedTime) *
          envelope *
          0.05;
      }
    }
...
const generateElectronicClick = (duration = 0.05) => {
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    // Sharp digital click
    let sample =
      Math.sign(Math.sin(2 * Math.PI * 2000 * time)) * envelope * 0.4;
...
const generateRetroClick = (duration = 0.1) => {
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    // 8-bit style click
    let sample =
      Math.sign(Math.sin(2 * Math.PI * 1000 * time)) * envelope * 0.3;
...
const generateRetroSuccess = (duration = 0.8) => {
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    for (let h = 3; h <= 7; h += 2) {
      sample +=
        Math.sign(Math.sin(2 * Math.PI * freq * h * time)) *
        envelope *
        (0.1 / h);
    }
    // 8-bit quantization
...
const generateCyberpunkClick = (duration = 0.08) => {
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    let sample =
      Math.sign(Math.sin(2 * Math.PI * 1500 * time)) * envelope * 0.5;
...
const generateCyberpunkSuccess = (duration = 0.8) => {
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    const frequencies = [130.81, 146.83, 164.81, 196.0]; // C3 to G3
    let sample = 0;
    for (let j = 0; j < frequencies.length; j++) {
      ...
      if (j === noteIndex) {
        ...
        sample +=
          Math.sign(Math.sin(2 * Math.PI * freq * time)) * envelope * 0.4;
        sample +=
          Math.sign(Math.sin(2 * Math.PI * freq * 2 * time)) * envelope * 0.1;
      }
    }
    samples.push(sample);
  }
    ...
    for (let j = 0; j < frequencies.length; j++) {
      ...
      if (time >= delay) {
        ...
        sample +=
          ...
          0.2;
        sample +=
          Math.sin(2 * Math.PI * frequencies[j] * 2.5 * adjustedTime) *
          envelope *
          0.1;
        sample +=
          Math.sin(2 * Math.PI * frequencies[j] * 4 * adjustedTime) *
          envelope *
          0.05;
      }
    }
...
const generateClassicalSuccess = (duration = 1.5) => {
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    const chord2 = [587.33, 739.99, 880.0]; // D minor
...
const generateLofiSuccess = (duration = 0.9) => {
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    const frequencies = [261.63, 329.63, 392.0, 523.25]; // C major 7th arpeggio
    let sample = 0;
...
const generateAmbientSuccess = (duration = 2.0) => {
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    const frequencies = [261.63, 329.63, 392.0, 523.25, 659.25]; // C major scale
    let sample = 0;
    ...
    for (let j = 0; j < frequencies.length; j++) {
      ...
      if (time >= delay) {
        ...
        // Add subtle detuning
        sample +=
          Math.sin(2 * Math.PI * (frequencies[j] * 1.003) * adjustedTime) *
          envelope *
          0.08;
      }
    }
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    for (let j = 0; j < frequencies.length; j++) {
      ...
      if (time >= delay) {
        ...
        sample +=
          Math.sign(Math.sin(2 * Math.PI * frequencies[j] * adjustedTime)) *
          envelope *
          0.1;
      }
    }
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    for (let j = 0; j < frequencies.length; j++) {
      ...
      if (time >= delay) {
        ...
        sample +=
          Math.sin(2 * Math.PI * frequencies[j] * 1.5 * adjustedTime) *
          envelope *
          0.1;
      }
    }
  ...
  for (let i = 0; i < totalSamples; i++) {
    ...
    switch (themeStyle) {
      case "nature":
        ...
        sample =
          Math.sin(2 * Math.PI * (440 + Math.sin(time * 2) * 50) * time) * 0.6;
        sample +=
          Math.sin(2 * Math.PI * (660 + Math.sin(time * 1.5) * 30) * time) *
          0.4;
      ...
      case "electronic":
        ...
        sample =
          Math.sign(Math.sin(2 * Math.PI * 880 * time)) * 0.7 * pulseRate;
      ...
      case "fantasy":
        ...
        for (let j = 0; j < magicFreqs.length; j++) {
          ...
          if (phase < 0.8) {
            sample +=
              Math.sin(2 * Math.PI * magicFreqs[j] * time) *
              Math.exp(-phase * 3) *
              0.25;
          }
        }
      ...
      case "ambient":
        ...
        sample += Math.sin(2 * Math.PI * 392.0 * time) * 0.2;
      ...
      case "workout":
        ...
        sample +=
          Math.sign(Math.sin(2 * Math.PI * 440 * time)) * 0.4 * intensity;
        break;
