          ...
          <TabsContent value="automation" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Connect with your email platforms and automate campaign
                  workflows
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Intelligent triggers and workflows
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {[
                    ...
                    },
                    {
                      ...
                      description:
                        "Send premium campaigns when usage hits thresholds",
                      status: "active",
                      triggered: 356,
                    },
                    {
                      name: "Re-engagement",
                      description:
                        "Target inactive users with win-back campaigns",
                      status: "paused",
                      triggered: 89,
                    },
                  ].map((rule, index) => (
