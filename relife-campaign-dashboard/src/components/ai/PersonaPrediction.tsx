...
export function PersonaPrediction({ className }: PersonaPredictionProps) {
  ...
  const personaProfiles = {
    struggling_sam: {
      name: "Struggling Sam",
      description:
        "Free tier user, inconsistent sleep patterns, needs motivation",
    ...
    professional_paula: {
      ...
      description:
        "Power user, advanced features, premium subscriber, data-driven",
  ...
  const predictPersona = async (
    ...
    if (
      subscriptionStatus === "premium" &&
      engagementMetrics.emailOpenRate > 45
    ) {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Use AI to automatically predict user personas based on behavior
                patterns
              </CardDescription>
            </div>
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between">
                            ...
                            <div className="text-right text-sm">
                              <div>
                                Engagement:{" "}
                                {user.engagementMetrics.emailOpenRate.toFixed(
                                  1,
                                )}
                                %
                              </div>
                              <div className="text-gray-500">
                                {user.engagementMetrics.appUsageMinutes}min
                                usage
                              </div>
                            </div>
                          </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <Card>
                        <CardContent className="p-4">
                          ...
                          <div className="space-y-2">
                            {prediction.recommendedCampaigns.map(
                              (campaign, index) => (
                                <div
                                  key={index}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-4 bg-green-50 rounded-lg">
                      ...
                      <div className="text-sm text-green-700">
                        Email open rates and app usage time are strong
                        indicators
                      </div>
                    </div>
